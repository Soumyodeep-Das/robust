...
struct WebsocketControllersRouter::CtrlBinder
{
    std::string controllerName_;
    std::vector<std::string> filterNames_;
    std::vector<std::shared_ptr<drogon::HttpFilter>> filters_;
    std::shared_ptr<WebSocketControllerBase> controller_;
    bool isCORS_{false};
};

struct WebsocketControllersRouter::WebSocketControllerRouterItem
{
