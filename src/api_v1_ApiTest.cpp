...
#include <functional>
#include <memory>
#include "HttpRequestPtr.h"
#include "HttpResponsePtr.h"
#include "HttpViewData.h"
#include "AttributesPtr.h"
#include "Json/json.h"
#include "Logger.h"
    ...
    int p2) const
{
    ...
    para["p3"] = HttpViewData::htmlTranslate(std::string(
                   ...
                   std::string &&p1)
{
    ...
    res->setBody(
        ...
        "\n"
        "/Applications/Adobe Photoshop CC/Adobe Photoshop "
        "CC.app/Contents/Application Data/Custom File Info Panels/4.0/bin/loc:\n"
        "FileInfo_ar_AE.dat\n"
        "FileInfo_bg_BG.dat\n"
        "FileInfo_cs_CZ.dat\n"
        "FileInfo_da_DK.dat\n"
